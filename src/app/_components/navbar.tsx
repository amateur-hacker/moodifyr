...
const Navbar = async () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-3 border-b bg-background/80 text-foreground shrink-0 gap-5 sticky top-0 inset-x-0 z-[50] backdrop-blur-md">
