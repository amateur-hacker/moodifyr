...
import { FollowMoodlistButton } from "@/app/(app)/moodlists/user/[userId]/[moodlistId]/_components/follow-moodlist-button";
        ...
        <>
          <div className="mb-4">
            ...
            {!!(
              ...
              moodlistSongsStats?.totalSongs &&
              moodlistSongsStats.totalTime
            ) && (
              <PlayHeader
